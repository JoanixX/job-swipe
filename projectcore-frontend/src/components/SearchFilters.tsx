...
export default function SearchFilters({ onClose, onApply }: SearchFiltersProps) {
  ...
  return (
    <motion.div 
      ...
      exit={{ opacity: 0, y: 20 }}
      className="fixed inset-0 bg-gray-50 dark:bg-gray-800 z-50 flex flex-col overflow-y-auto"
    >
      {/* Header */}
      <div className="bg-white dark:bg-gray-900 py-4 px-4 flex items-center justify-between sticky top-0 z-10 border-b border-gray-100 dark:border-gray-800">
        <button onClick={onClose} className="p-2 -ml-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
          <ChevronLeft className="w-6 h-6" />
        </button>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Filtros de Búsqueda</h2>
        <button onClick={handleClear} className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
          Limpiar
        </button>
      </div>
      ...
      <div className="p-4 flex-1 space-y-4 pb-24">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Salario Mínimo Esperado (S/)</h3>
          <div className="flex items-center space-x-2 mb-4">
            <span className="text-gray-500 dark:text-gray-400 text-lg">S/</span>
            <input 
              type="number" 
              value={minSalary}
        ...
        {/* Modalidad */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Modalidad de Trabajo</h3>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Selecciona una o más opciones</p>
        ...
        {/* Distritos */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Distritos de Lima</h3>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Selecciona los distritos donde buscas trabajar</p>
          <div className="flex flex-wrap gap-2">
