...
from app.adapters.output.orm.repositories.password_reset_token_repository_impl import PasswordResetTokenRepositoryImpl
...
class AppUserUseCaseFactory:
    ...
    def build(self) -> AppUserUseCase:
        ...
        reset_token_repo = PasswordResetTokenRepositoryImpl(self.session)
        return AppUserUseCase(app_user_port, app_user_service, reset_token_repo)